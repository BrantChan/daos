...
const (
	grumbleUnknownCmdErr = "unknown command, try 'help'"
	runCmdArgsErr        = "Cannot use both command file and a command string"
	vosPathMissErr       = "Cannot use sys db path without a vos path"
)
